...
export declare class HealthRecordsService {
    ...
    constructor(healthRecordModel: Model<HealthRecord>, userModel: Model<User>, usersService: UsersService);
    create(createHealthRecordDto: CreateHealthRecordDto, request: Request): Promise<HealthRecord>;
